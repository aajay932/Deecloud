...
<form data-can-create="<?php echo $canCreateMounts?'true':'false' ?>" id="files_external" class="section" data-encryption-enabled="<?php echo $_['encryptionEnabled']?'true': 'false'; ?>">
	...
	<p class="settings-hint"><?php p($l->t('External storage enables you to mount external storage services and devices as secondary Deecloud storage devices. You may also allow users to mount their own external storage services.')); ?></p>
