...
<div id="password-policy" class="section">
	...
	<p class="password-policy-settings-hint">
		<?php p($l->t('This check creates a hash of the password and sends the first 5 characters of this hash to the haveibeenpwned.com API to retrieve a list of all hashes that start with those. Then it checks on the Deecloud instance if the password hash is in the result set.'));?>
	</p>
</div>
